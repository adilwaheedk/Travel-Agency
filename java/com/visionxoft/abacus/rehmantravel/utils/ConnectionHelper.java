...
/**
 * Helper class for network connection related functions.
 */
public class ConnectionHelper {
     ...
     *
     * @param bytes Value in array of byte
    ...
    public static String bytesToHex(byte[] bytes) {
        ...
        for (byte aByte : bytes) {
            ...
            if (intVal < 0x10) builder.append("0");
            builder.append(Integer.toHexString(intVal).toUpperCase());
        }
